...
class ParagraphsTest extends ParagraphsTestBase {
  ...
  public function testListItemBlock() {
    ...
    $this->assertCount(0, $crawler->filter('div.ecl-content-item-block__item.ecl-col-lg-6 article.ecl-content-item'));
    $this->assertCount(0, $crawler->filter('div.ecl-content-item-block__item.ecl-col-lg-4 article.ecl-content-item'));
    ...
    $crawler = new Crawler($this->renderParagraph($paragraph));
    $this->assertCount(3, $crawler->filter('div.ecl-content-item-block__item.ecl-col-lg-6 article.ecl-content-item'));
    $this->assertCount(0, $crawler->filter('div.ecl-content-item-block__item.ecl-col-lg-4 article.ecl-content-item'));
    ...
    $crawler = new Crawler($this->renderParagraph($paragraph));
    $this->assertCount(0, $crawler->filter('div.ecl-content-item-block__item.ecl-col-lg-6 article.ecl-content-item'));
    $this->assertCount(3, $crawler->filter('div.ecl-content-item-block__item.ecl-col-lg-4 article.ecl-content-item'));
  }
